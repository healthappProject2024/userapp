...
class GetStarted extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    precacheImage(AssetImage(ImageHelper.introductionImage,), context);
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Text(
              ...
              style: Theme.of(context)
                  .textTheme
                  .headlineLarge
                  ?.copyWith(fontSize: 36.sp, color: MyColors.gradientEndColor,),
            ),
            Text(
      ...
      floatingActionButton: Padding(
        ...
        child: CommonButton(
          ...
          onPressed: () =>
              Navigator.pushReplacementNamed(context, RouteName.introduction),
        ),
      ),
